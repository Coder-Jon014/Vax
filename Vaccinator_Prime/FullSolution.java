...
public class FullSolution {
    ...
    { 
        ...
        if (choice.equals("Y"))
        {
            ...
            System.out.println("Enter number of testcase[0..5] to prime data, [T/t] to Run [T]est Cases or [F/f] for free entry, or [X/x] to  exit ");
               ...
               try
                {
                    ...
                    System.out.println("[T]est Cases\n[P]erson entry\n[A]pproval info\n[V]accine batch\n[S]how data\npro[C]ess vaccinations\n[R]eport\nEnter [I]D\ne[X]it");
